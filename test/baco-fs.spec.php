...
class WP_Plugin_Baco_FsTest extends TestCase {
  ...
  public function test_static_methods() {
    $this->assertEquals( method_exists( 'WP_Plugin_Baco_Fs', 'tmpdir' ), true );
    $this->assertEquals( method_exists( 'WP_Plugin_Baco_Fs', 'cp' ), true );
    $this->assertEquals( method_exists( 'WP_Plugin_Baco_Fs', 'rimraf' ), true );
  }
